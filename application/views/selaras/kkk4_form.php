  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="background-color: #e2f3f5">
      ...
      <section class="content" style="background-color: #e2f3f5">
        <div class="container-fluid">
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Sinkronisasi Target</h3>
  <div class="card-body">
    <div>
      <form action="<?php echo base_url(). 'home/tambah_aksi'; ?>" method="post">
        <span>//munculkan tujuan rpjmn dari index per id</span>
        <span>//munculkan sasaran rpjmn dari index per id</span>
        <span>//munculkan indikator sasaran rpjmn dari index per id</span>
        <span>//munculkan indikator sasaran rpjmd dari index per id</span>
      ...
      <a href="<?=base_url('kkk4/index')?>"><input type="submit" value="Batal"></a>
        </div>
      </section>
      </section>
      <!-- /.content -->
