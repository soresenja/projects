    ...
    <div class="content-wrapper" style="background-color: #e2f3f5">
      ...
      <section class="content" style="background-color: #e2f3f5">
        <div class="container-fluid">
          <!-- Editable table -->
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Analisis Keselarasan RKPD dengan RKP : Keselarasan Prioritas Nasional dan Daerah</h3>
  <div class="card-body">
    <div>
      <p>Provinsi: </p>
      <p>Tahun: 2020</p>
  ...
  <thead>
    <tr>
      <th colspan="5" scope="col" style="background-color: #88bef5">RKP</th>
      <th colspan="5" scope="col" style="background-color: #ffa45c">RKPD</th>
    ...
    <tr>
      ...
      <th scope="col">Prioritas Daerah</th>
      <th scope="col">SASARAN</th>
      <th scope="col">INDIKATOR</th>
      <th scope="col">Target</th>
      <th scope="col">Satuan</th>
