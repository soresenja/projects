...
<div class="card">
  ...
  <div class="card-body">
    <div>
      <span class="float-right mb-3 mr-2">
        <a href="<?=base_url('kkk1/input')?>" class="text-success">
  ...
  <thead>
    <tr>
      ...
      <th class="text-center" scope="col">RPJMN</th>
      <th class="text-center" scope="col">RJMD Provinsi</th>
  ...
  <tbody>
    ...
    <?php
    $no = 1;
    foreach($sync_rpjmd as $s){
    ?>
    <tr>
      <td><?php echo $no++ ?></td>
      <!--
      kolom rpjmn pada database diganti id_isu_rpjmn, mengambil data dari sumber: tabel daftar_rpjmn
      kolom ini otomatis menampilkan seluruh data pada database daftar_isurpjmn
      -->
        <td><?php echo $s->isu_rpjmn ?></td>
        <td><?php echo $s->rpjmd ?></td>
      ...
      -->
        ...
        <td><?php echo anchor('kkk1/hapus/'.$s->id_sync_rpjmd,'Hapus'); ?></td>
        <!--
        edit untuk mengisi/edit kolom 3-5 pada tabel view
      -->
        <td><a href="<?=base_url('kkk1/input')?>">edit</a></td>
    </tr>
  <?php } ?>
  <tr>
    <td></td>
